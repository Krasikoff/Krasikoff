...
проект компании vink по парсингу (scrapy) сайтов конкурентов. https://github.com/Vink-Masterskaya/vink-master/. Выполнил парсинг больше половины из требуемых сайтов. В одном из них пришлось парсить через недокументированное api(Laravel CMS).
